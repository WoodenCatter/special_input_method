...
- Source: https://github.com/shibing624/chinese-chess-ai
- Files adapted: HTML, CSS, JavaScript game engine, AI, UI, and generated audio
- Packaged location: `app/src/main/assets/chinese_chess/`
- License: Apache License 2.0
- Changes: removed CDN dependencies and hint UI; added an offline tablet layout,
